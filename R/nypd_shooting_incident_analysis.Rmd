#uses additional external library(maps) and library(effects)
...
This dataset reveals some interesting patterns in reported shooting incidents in New York City that may suggest some of the underlying dynamics.

Probably the most significant finding of this analysis is that there appears to be a strong intra-racial dyanmic driving most of the shooting incidents in NYC. Black and Hispanic New Yorkers comprise over 95% of the shooting victims in this dataset (analysis B), and 61% of shootings were found to involve both perpetrators and victims of the same race (analysis F). Additionally, using these "same race" records as a predictor variable, modeling found that shooting incidents involving both perpetrators and victims of the same race were much more likely to result in murder (approx 24% more likely, with high statistical significance - analyses F and G). This could indicate that many of these incidents are targeted shootings among common social and ethnic groups, as opposed to random gunfire or other crimes involving guns which may be less likely to result in murder. Additionaly, Men in NYC are much more likely to be both the victim and perpetrator of a shooting incident in NYC, though there are still many female victims of male perpetrators (analysis A). 

However, there are many potential bias sources that could affect this analysis. For example, shootings among Black or Hispanic New Yorkers could be much more likely to be reported in the NYPD dataset relative to other shootings due to institutional racial bias. Likewise, if all of the facts of an incident are not known, the reporting authorities may default to recording a suspected a Black or Hispanic perpetrator.

I believe I have done my best to not allow any personal biases to affect this analysis, though I acknowledge I do not have any firsthand experience or knowledge of the social context of NYC or the social dynamics of this population, and this analysis is very superficial. 
